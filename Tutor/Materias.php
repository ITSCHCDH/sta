...
<head>
    ...
    <link rel="stylesheet" href="/sta/assets/css/bootstrap-theme.min.css">
    <link href="/sta/assets/css/jquery.dataTables.min.css" rel="stylesheet">
...
<body>
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="#">Materias</a></li>
                            </ul>
            ...
            <div class="row">
                <div class="col-md-4  col-md-offset-2 ">
                    <div class="form-group">
                        <label for="GrupoMat">Seleccione un grupo</label>
                        <select id="GrupoMat" class="form-control">
                            <?php
                            require_once $_SERVER["DOCUMENT_ROOT"].'/sta/php/clases/Tutor.php';
                            $Grup = new tutor();
                            $Grup->ConsultarGrupos(0);
                            ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-4 ">
                    <div class="form-group">
                        <label for="CalMat">Seleccione una Materia</label>
                        <select id="CalMat" class="form-control">
                        </select>
                    </div>
                </div>
            </div>
            <hr>
            <input type="button" id="btnex" class="form-group" value="Excel" style='display:none';>
            <div id="Materias">

                <div id="CalMaterias"></div>
    ...
    <script src="https://cdn.datatables.net/fixedcolumns/3.2.6/js/dataTables.fixedColumns.min.js" charset="utf-8"></script>
    ...
    <script type="text/javascript">
        $('#CalMat').on('change', function() {
            if ($('#CalMat').val()=='todas') {
                ...
                $('#btnex').css('display','none');
            }
        });
    </script>
    <script>
        $("#btnex").click(function(e) {
            window.open('data:application/vnd.ms-excel,' + encodeURIComponent($('#CalMaterias').html()));
            e.preventDefault();
        });

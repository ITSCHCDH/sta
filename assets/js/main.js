...
$("#GrupoTu").on("change", function() {
    var idG = $("#GrupoTu").val();
    var url = "/php/init/GROUP_Listar.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#GrupoGE").on("change", function() {
    var idG = $("#GrupoGE").val();
    var url = "/php/init/GROUP_ListarGen.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#GrupoGE2").on("change", function() {
    ...
    var url = "/php/init/GROUP_ListarGen2.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#GrupoTuPDF").on("change", function() {
    ...
    var url = "/php/init/GROUP_ListarPDF.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#gpoAsignS").on("change", function() {
    ...
    var url = "/php/init/tutorGpoAsign.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#GrupoMat").on("change", function() {
    ...
    var url = "/php/init/tutor.Materias-Listar_Materia.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#GrupoGen").on("change", function() {
    ...
    var url = "/php/init/Jfe_CalMat.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#CalMat").on("change", function() {
    ...
    var mate = $("#CalMat").val();
    if ($("#CalMat").val() == "todas") {
        var url = "/php/init/TU_CalMat2.php";
    } else {
        var url = "/php/init/tutor.Grupo-CalificacionMaterias.php";
    }
    $.ajax({
        type: "POST",
        url: url,
...
$("#MatDoce").on("change", function() {
    ...
    var url = "/php/init/PRO_calificacion.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#PSGrupo").on("change", function() {
    var idG = $("#PSGrupo").val();
    var idC = $("#PScarrera").val();
    var url = "/php/init/GROUP_ListarGenCar.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#DirCarrera").on("change", function() {
    ...
    var url = "/php/init/ps_grupoXCarrera.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#DirGrupo").on("change", function() {
    ...
    var idC = $("#DirCarrera").val();
    var url = "/php/init/GROUP_ListarGen3.php";
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
$("#carac").on("click", function(event) {
    ...
    jQuery
        .ajax({
            url: "/php/init/ADM_Caracterizacion.php",
            type: "POST",
            dataType: "json",
            beforeSend: function() {
                myFunction();
...
jQuery(document).on("submit", "#form_conte", function(event) {
    ...
    jQuery
        .ajax({
            url: "/php/init/GROUP_Insertar.php",
            type: "POST",
            dataType: "json",
            data: $(this).serialize(),
        })
...
jQuery(document).on("submit", "#form_AluAcept", function(event) {
    ...
    jQuery
        .ajax({
            url: "/php/init/Alu_Registrar.php",
            type: "POST",
            dataType: "json",
            data: $(this).serialize(),
            beforeSend: function() {
...
$("#saveAlu").click(function(event) {
    ...
    if (nocon === "") {
        sendMessageR(
            "No a introducido ningun numero de control para buscar",
            ""
        );
        return false;
    }
...
$("#saveUserAT").click(function(event) {
    ...
    if (contrasena != contrasena2) {
        alert(
            "La contraseña deben coincidir en caso de que las ayas modificado"
        );
        return false;
    }
...
$("#saveUserTU").click(function(event) {
    ...
    if ($("#DocSelc").is(":checked")) {
        ...
        url = "/php/init/TU_Registrar2.php";
...
$("#saveUserJefe").click(function(event) {
    ...
    if ($("#DocSelc").is(":checked")) {
        url = "/php/init/JFE_Actualizar.php";
        var clave = $("#clavcat").val();
        ...
        url = "/php/init/JFE_Registrar.php";
        var nom = $("#nombreDoc").val();
        var ap = $("#APa").val();
        var am = $("#AMa").val();
        var contrasena = $("#Pass").val();
...
$("#gpo_save").click(function(event) {
    ...
    jQuery
        .ajax({
            url: "/php/init/GROUP_Registrar.php",
            type: "POST",
            dataType: "json",
            data: {
                clavcat: Doc,
...
$("#saveUserMedico").click(function(event) {
    ...
    jQuery
        .ajax({
            url: "/php/init/MED_Registrar.php",
            type: "POST",
            dataType: "json",
            data: {
                nom: nombre,
...
$("#saveUserPsico").click(function(event) {
    ...
    jQuery
        .ajax({
            url: "/php/init/PSI_Registrar.php",
            type: "POST",
            dataType: "json",
            data: {
                nom: nombre,
...
function EliminarAlu(num) {
    var idG = $("#GrupoTu").val();
    var url = "/php/init/Alu_Eliminar.php";
    ...
    if (respuesta) {
        $.ajax({
            ...
            success: function(data) {
                if (data.err !== false) {
                    sendMessageR(
                        "El alumno a sido eliminado correctamente.",
                        "#5cb85c"
                    );
                    ActTabAlu();
                } else {
...
function JFE_Eliminar(id, car, nom) {
    var opcion = confirm(
        "Desea eliminar el acceso de Jefe de carrera  a " + nom
    );
    if (opcion == true) {
        jQuery
            .ajax({
                url: "/php/init/JFE_Eliminar.php",
                type: "POST",
                dataType: "json",
                data: {
                    id_cat: id,

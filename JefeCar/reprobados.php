        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-main">
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li><a href="/sta/JefeCar"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></li>
                    <li><a href="grupos.php">Grupos</a></li>
                    <li><a href="cali.php">Calificaciones</a></li>
                    <li class="active"><a href="#">Reprobados</a></a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-md-offset-3 col-lg-offset-3">
                    <div class="form-group">
                        <label for="GrupoGE2">Seleccione una generación</label>
                        <select id="GrupoGE2" class="form-control">
                            <?php

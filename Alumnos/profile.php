...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-main">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li><a href="index.php">FICHA DE IDENTIFICACIÓN</a></li>
    ...
    <div class="container cuerpo">
        <?php $Alu->perfil($_SESSION['usuario']['Tipo'], $_SESSION['usuario']['Clave']);?>
    ...
    <div class="modal fade" id="Caract" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="width: 70%">
            <div class="modal-content">
                <div class="modal-header text-center" style="background-color: #b40b0b; color: #fff;"> <h3 class="modal-title" id="myModalLabel"> IMPORTANTE. </h3>
                </div>
                <div class="modal-body">
                    <div class="container" style="width:100%">
                        <div class="row">
                            <div class="col-md-12">
                                <p>Al parecer no te encuentras caracterizado dentro del sistema, por lo tanto, es importante que termines de llenar este formulario y guarde hasta el final.</p><h5>MUCHAS GRACIAS</h5>
                            </div>
                        </div>
                    </div>

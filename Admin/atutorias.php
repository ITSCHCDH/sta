...
<body>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a href="#">Área Tutorías</a></li>
    ...
    <div class="modal fade" id="userAlt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form id="form_atuto" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="correo" placeholder="correo@itsch.edu.mx" name="correo">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="modal-footer">
                        <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                            ...
                            <button style="width:49.5%;" type="button" id="saveUserAT" class="btn btn-lg btn-primary " data-action="save" role="button">Guardar</button>
                        </div>
                    </div>
                </form>
            </div>

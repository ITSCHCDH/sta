                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="icon_genius"></i>  SICE</li>
                        </ol>
                    </div>
                </div>
                <!-- page start-->
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="jumbotron">
                                ...
                                <p>
                                    Recuerde que esta sección es únicamente para actualizar la lista de docentes si es que se a agregado alguien mas dentro de SICE.
                                </p>
                                <p class="text-center">
                                    <button id="sice" class="btn btn-primary btn-large" >Actualizar</button>
                                </p>
                            </div>
                        </div>
                    </div>

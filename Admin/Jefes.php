<?php
    ...
    $Adm = new AdminUser();
    require_once $_SERVER["DOCUMENT_ROOT"].'/sta/php/clases/Carreras.php';
    $Car = new Carrera();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="/sta/assets/css/jquery.loadingModal.min.css">
...
<body>
    ...
    <section id="container" class="">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li  class="active"><a class="" href="#">Jefes de carrera</a></li>
                        </ul>
                    </li>
                    <li>
                ...
                <div class="content-box-large">
                    <div class="panel-heading">
                        <div class="pull-right">
                            <button type="button" data-toggle="modal" data-target="#AgregarJfe" class="btn btn-primary center-block">Agregar Jefe de carrera</button>
                        </div>
        ...
        <div class="modal fade" id="AgregarJfe" tabindex="-1" role="dialog" aria-labelledby="AgregarJfeLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form" method="post" id="JefeCarForm">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span></button>
                            <h3 class="modal-title" id="AgregarJfeLabel">Nuevo Jefe de carrera.</h3>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="DirCarrera2" class="col-sm-2 control-label">Carreras</label>
                                <select class="form-control" id="DirCarrera2" name="DirCarrera" required>
                                    <?php $Car->ConsultarCarrera(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                                ...
                                <button style="width:49.5%;" type="button" id="saveUserJefe" class="btn btn-lg btn-primary " data-action="save" role="button">Guardar</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal fade" id="editarDoctor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="POST">
                        <div class="modal-header">
                            <h3 class="modal-title" id="myModalLabel">Editar doctor.</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span> </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="nombredoctor" class="col-form-label">Nombre del doctor:</label>
                                <input type="text" class="form-control" name="nombredoctor" id="nombredoctor" required="Obligatorio">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                                <button style="width:49.5%;" type="button" class="btn btn-lg btn-danger" data-dismiss="modal" role="button">Cerrar</button>
                                <input  style="width:49.5%;" type="button" id="updateUserMedico" class="btn btn-lg btn-success" value="Guardar"></input>
                            </div>
                        </div>
                    </form>
                </div>

                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="icon_cloud-download_alt"></i>Caracterización</li>
                        </ol>
                    </div>
                </div>
                <!-- page start-->
                <div class="content-box-large container-fluid">
                    <div class="panel-heading">
                        <h3 class="panel-title">Caracterización</h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="jumbotron">
                                ...
                                <p>
                                    Recuerde que esta sección es únicamente para antes de comenzar el ciclo escolar y pasar los datos importantes de caracterización a trayectoria escolar.
                                </p>
                                <p class="text-center">
                                    <button id="carac" class="btn btn-primary btn-large" >Trasladar</button>
                                </p>
                            </div>
                        </div>
                    </div>

...
<body>
    ...
    <section id="container" class="">
                ...
                <div class="content-box-large">
                    <div class="panel-heading">
                        <div class="pull-right">
                            <button type="button" data-toggle="modal" data-target="#AgregarDoc" class="btn btn-primary center-block">Agregar Doctor</button>
                        </div>
        ...
        <div class="modal fade" id="AgregarDoc" tabindex="-1" role="dialog" aria-labelledby="AgregarDocLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form" method="post">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span></button>
                            <h3 class="modal-title" id="AgregarDocLabel">Nuevo doctor.</h3>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="nombredoc" class="col-form-label">Nombre del doctor:</label>
                                <input type="text" class="form-control" name="nombredoctor" id="nombredoc" required="">
                            </div>
                            <div class="form-group">
                                <label for="APa" class="col-form-label">Apellido paterno:</label>
                                <input type="text" class="form-control" name="appaternodoctor" id="APa" required="">
                            </div>
                            <div class="form-group">
                                <label for="AMa" class="col-form-label">Apellido materno:</label>
                                <input type="text" class="form-control" name="apmaternodoctor" id="AMa" required="">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                                ...
                                <button style="width:49.5%;" type="button" id="saveUserMedico" class="btn btn-lg btn-primary " data-action="save" role="button">Guardar</button>
                            </div>
                        </div>
                    </form>
                </div>

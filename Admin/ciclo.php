            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="icon_cloud-download_alt"></i>Cierre de ciclo</li>
                        </ol>
                    </div>
                </div>
                <!-- page start-->
                <div class="content-box-large container-fluid">
                    <div class="panel-heading">
                        <h3 class="panel-title">CIerre de ciclo escolar</h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="jumbotron">
                                <p class="text-center">
                                    <a href="/sta/php/init/ADM_Ciclo.php" id="ciclo" class="btn btn-primary btn-large" >Terminar ciclo</a>
                                </p>
                            </div>
                        </div>
                    </div>
